...
public class Empregado {
  ...
  float valorHoraExtra() {
    return this.salarioPorHora + (this.salarioPorHora * this.porcentagemHoraExtra);
  }
  ...
  public static void main(String[] args) throws Exception {
    ...
    System.out.printf("Pagamento do salário:%n\t=> Horas normais: %.2f R$%n\t=> Horas extras: %.2f R$%n\t=> *Total: %.2f R$%n", empregado1.calcularPagamentoSemHorasExtras(), empregado1.calcularPagamentoHorasExtras(), empregado1.realizarPagamento());
